...
const PlatformIcon = ({ name }) => {
  switch (name.toLowerCase()) {
    ...
    case 'unstop':
      return (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 4.5c1.657 0 3 1.343 3 3S13.657 10.5 12 10.5 9 9.157 9 7.5s1.343-3 3-3zm0 15c-3.728 0-7-1.9-7-4.25v-.75c0-2.35 3.272-4.25 7-4.25s7 1.9 7 4.25v.75C19 17.6 15.728 19.5 12 19.5z"/>
        </svg>
      )
    case 'leetcode':
      return (
